                    ...
                    <table class="table table-striped table-hover border">
                        <thead class="bg-dark text-light">
                            <tr>
                                ...
                                <th class="d-none d-md-table-cell text-center text-md-left" scope="col">Position</th>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="validationServer01" placeholder="Name.." name="team_name" required>
                            ...
                            <div class="col-md-6">
                                <label for="validationServer03" class="form-label">Position</label>
                                <input type="text" class="form-control" id="validationServer03" placeholder="Position.." name="team_position" required>
                                <div class="invalid-feedback">
                                    Write a position!
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <label for="validationServer04" class="form-label">Link</label>
                                <input type="text" class="form-control" id="validationServer04" placeholder="Link.." name="team_link" required>
                                <div class="invalid-feedback">
                                    Insert a link!
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="file" class="form-control" id="validationServer05" name="team_photo">
                            </div>
...
<foot>
    ...
    <script src="<?= $DATA['http_domain'] ?>public/js.panel/team.js"></script>
</foot>
