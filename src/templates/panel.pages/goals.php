            ...
            <div class="modal-dialog">
                <form class="modal-content needs-validation" id="element-form" onsubmit="return false" novalidate>
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="element-modalformLabel">Goal Form</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="validationServer01" placeholder="Name.." name="goal_name" required>
                            ...
                            <div class="col-md-12">
                                <label for="validationServer02" class="form-label">Icon</label>
                                <input type="text" class="form-control" id="validationServer02" placeholder="Icono de Fontawesome.." name="goal_icon" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-12">
                                <center><a class="form-label" target="_blank" href="https://fontawesome.com/v5/search/">Search in fontawesome</a></center>
                            </div>
                        </div>
                        <!-- form | end -->
                    </div>
...
<foot>
    ...
    <script src="<?= $DATA['http_domain'] ?>public/js.panel/goals.js"></script>
</foot>
