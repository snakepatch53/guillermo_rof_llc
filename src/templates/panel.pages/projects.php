                    ...
                    <table class="table table-striped table-hover border">
                        <thead class="bg-dark text-light">
                            <tr>
                                ...
                                <th class="d-none d-md-table-cell text-center text-md-left" scope="col">Service</th>
                                <th class="d-none d-md-table-cell text-center text-md-left" scope="col">Origin</th>
            ...
            <div class="modal-dialog">
                <form class="modal-content needs-validation" id="element-form" onsubmit="return false" novalidate>
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="element-modalformLabel">Project Form</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="validationServer01" placeholder="Name.." name="project_title" required>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="validationServer02" placeholder="Description.." name="project_desc" required></textarea>
                                <div class="invalid-feedback">
                                    Write a description!
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="validationServer03" placeholder="Link.." name="project_link">
                                <div class="invalid-feedback">
                                    Insert a link!
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="file" class="form-control" id="validationServer04" name="project_img" required>
                                <div class="invalid-feedback">
                                    Select a image!
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <label for="validationServer05" class="form-label">Service*</label>
                                <select class="form-select" id="validationServer05" name="service_id" required>
...
<foot>
    ...
    <script src="<?= $DATA['http_domain'] ?>public/js.panel/projects.js"></script>
</foot>
