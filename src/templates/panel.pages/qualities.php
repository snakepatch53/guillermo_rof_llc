        ...
        <div class=" pt-4 px-md-5 px-1">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Qualities</li>
                </ol>
            </nav>
        ...
        <div class="modal fade" id="element-modalform" tabindex="-1" aria-labelledby="element-modalformLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form class="modal-content needs-validation" id="element-form" onsubmit="return false" novalidate>
                    <input type="hidden" name="quality_id" value="0">
                    <div class="modal-header">
                        <h5 class="modal-title" id="element-modalformLabel">Quality Form</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="validationServer01" placeholder="Name.." name="quality_title" required>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="validationServer02" placeholder="Description.." name="quality_desc" required></textarea>
                                <div class="invalid-feedback">
                                    Write a description!
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="file" class="form-control" id="validationServer03" name="quality_img" required>
                                <div class="invalid-feedback">
                                    Select a photo!
                                </div>
                            </div>
...
<foot>
    ...
    <script src="<?= $DATA['http_domain'] ?>public/js.panel/qualities.js"></script>
</foot>
